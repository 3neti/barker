                        ...
                        <div class="sm:flex sm:items-center sm:justify-between">
                            <div>
                                <div class="flex items-center gap-x-3">
                                    <h2 class="text-lg font-medium text-gray-800 dark:text-white">-Accounting- Requests</h2>
                                ...
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">These requests have been lodged in the last 48 hours.</p>
                            </div>
                                        ...
                                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                            ...
                                            <tr>
                                                <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                                    <div>
                                                        <h2 class="font-medium text-gray-800 dark:text-white ">Clark Kent</h2>
                                                        <p class="text-sm font-normal text-gray-600 dark:text-gray-400">processed a minute ago</p>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="px-12 py-4 text-sm whitespace-nowrap">
                                                    <div class="flex flex-wrap items-center gap-x-2 gap-y-1">
                                                        <p class="px-3 py-1 text-sm text-blue-500 rounded-full dark:bg-gray-800 bg-blue-100/60">full name</p>
                                                        <p class="px-3 py-1 text-sm text-blue-500 rounded-full dark:bg-gray-800 bg-blue-100/60">data of birth</p>
                                                        <p class="px-3 py-1 text-sm text-blue-500 rounded-full dark:bg-gray-800 bg-blue-100/60">date of expiry</p>
                                                        <p class="px-3 py-1 text-sm text-blue-500 rounded-full dark:bg-gray-800 bg-blue-100/60">address</p>
                                                        <p class="px-3 py-1 text-sm text-blue-500 rounded-full dark:bg-gray-800 bg-blue-100/60">year of birth</p>
                                                        <p class="px-3 py-1 text-sm text-blue-500 rounded-full dark:bg-gray-800 bg-blue-100/60">id number</p>
                                                        <p class="px-3 py-1 text-sm text-blue-500 rounded-full dark:bg-gray-800 bg-blue-100/60">nationality</p>
                                                    </div>
                                                </td>
                                                <td class="px-12 py-4 text-sm whitespace-nowrap">
                                                    <div class="flex flex-wrap items-center gap-x-2 gap-y-1">
                                            ...
                                            <tr>
                                                <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                                    <div>
                                                        <h2 class="font-medium text-gray-800 dark:text-white ">a gentleman</h2>
                                                        <p class="text-sm font-normal text-gray-600 dark:text-gray-400">requested 10 minutes ago</p>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                                    <div>
                                                        <h2 class="font-medium text-gray-800 dark:text-white ">Peter Parker</h2>
                                                        <p class="text-sm font-normal text-gray-600 dark:text-gray-400">processed an hour ago</p>
                                                    </div>
                                                </td>
                                                <td class="px-12 py-4 text-sm font-medium whitespace-nowrap">
                                                    <div class="inline px-3 py-1 text-sm font-normal rounded-full text-blue-500 gap-x-2 bg-blue-100/60 dark:bg-gray-800">
                                            ...
                                            <tr>
                                                <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                                    <div>
                                                        <h2 class="font-medium text-gray-800 dark:text-white ">a mobile subscriber</h2>
                                                        <p class="text-sm font-normal text-gray-600 dark:text-gray-400">processed 3 hours ago</p>
                                                    </div>
                                                </td>
                                                <td class="px-12 py-4 text-sm font-medium whitespace-nowrap">
                                            ...
                                            <tr>
                                                <td class="px-4 py-4 text-sm font-medium whitespace-nowrap">
                                                    <div>
                                                        <h2 class="font-medium text-gray-800 dark:text-white ">Bruce Banner</h2>
                                                        <p class="text-sm font-normal text-gray-600 dark:text-gray-400">processed 4 hours ago</p>
                                                    </div>
                                                </td>
                                                <td class="px-12 py-4 text-sm font-medium whitespace-nowrap">
                                                    <div class="inline px-3 py-1 text-sm font-normal rounded-full text-blue-500 gap-x-2 bg-blue-100/60 dark:bg-gray-800">
